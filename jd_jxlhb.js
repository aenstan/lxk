...
!(async () => {
  ...
  let res2 = await getAuthorShareCode('https://gitee.com/seec/share-codes/raw/master/jd_jxlhb.json') || [];
...
function getAuthorShareCode(url = "https://gitee.com/seec/share-codes/raw/master/jd_jxlhb.json") {
  return new Promise(resolve => {
    const options = {
